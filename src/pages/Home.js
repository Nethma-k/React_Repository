        ...
        <div class="columns">
            <div class="column is-6 ">
                <figure class="image im  ">
                    <img class="is-rounded" src="Picture 1.jpg"/>
                  </figure>
            </div>
              ...
              <div class='card equal-height'>
                <div class="card-image has-text-centered pt-5">
                    <figure class="image is-128x128 is-inline-block">
                        <img class="is-rounded" src="picture 2.png"/>
                    </figure>
                </div>
                <div class='card-content'>
                ...
                <div class='card equal-height'>
                  <div class="card-image has-text-centered pt-5">
                      <figure class="image is-128x128 is-inline-block">
                          <img class="is-rounded" src="picture 3png.png"/>
                      </figure>
                  </div>
                  </div>
                  <div class='card-content'>
                  ...
                  <div class="card-image has-text-centered pt-5">
                      <figure class="image is-128x128 is-inline-block">
                          <img class="is-rounded" src="picture 4.png"/>
                      </figure>
                  </div>
                  </div>
                  <div class='card-content'>
